...
import 'package:yamazone/controller/extra_pages/faqs_controller.dart';
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              MyButton(
                                ...
                                backgroundColor: contentTheme.primary.withAlpha(
                                  28,
                                ),
    ...
    return Row(
      ...
      children: [
        MyContainer(
          ...
          child: Center(
            child: Icon(icon, size: 16, color: contentTheme.primary),
          ),
        ),
        MySpacing.width(16),
        Expanded(
          child: Column(
            ...
            children: [
              ...
              MySpacing.height(4),
              MyText.bodySmall(description, maxLines: 2),
            ],
          ),
        ),
      ],
