...
import 'package:yamazone/controller/auth/locked_2_controller.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      Center(
                        child: MyText.titleLarge("locked", fontWeight: 700),
                      ),
                      MySpacing.height(8),
                      Center(child: MyText("Hi ! Den")),
                      MySpacing.height(16),
                      Center(
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          MyText.labelMedium("Password", fontWeight: 600),
                          MySpacing.height(8),
                          TextFormField(
